...
const MaternityBenefitsData = tableData.map((item) => ({
    1: item[1],
    2: item[2],
    3: (
...
function MaternityBenefits() {
    return (
        <div>
            <div className="company-managment-action-row">
                <Breadcrumbs title={"Maternity Benefits"} currentPage={"Maternity Benefits"} />
            ...
            <TableView tableHead={tableHead} tableData={MaternityBenefitsData} searchRow={true} filterRow={true} />
        </div>
    )
}
